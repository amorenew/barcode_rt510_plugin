package com.android.hdhe.barcode.reader;

import android.util.Log;
import android.view.MotionEvent;

import com.android.hdhe.barcode.consts.Constants;
import com.android.hdhe.barcode.readerInterface.CommendManager;
...
public class NewSendCommendManager implements CommendManager {
   ...
   /* public boolean setOutputPower(int r5) {
        ...
        throw new UnsupportedOperationException("Method not decompiled: com.android.hdhe.barcode.reader.NewSendCommendManager.setOutputPower(int):boolean");
    }*/
